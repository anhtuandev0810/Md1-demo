...
let acc;
let slideArr = ['../img/dongiolanh-banner-web_2880x960-.jpg', '../img/homewear-top-desktop_2880x960_1.jpg'];
let i = 0;
    ...
    renderProduct.map((e) => {
        ...
        <div class="card" style="width: 23%;height: 400px">
            ...
            <div class="card-body">
                ...
                <div class="card-text">
                    <div class="card-text-1">Giá: <span class="card-price">${VND.format(e.price)}</span></div>
